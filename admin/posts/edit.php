...
<body>
	...
	<div class = "admin-wrapper">
		...
		<div class = "admin-content">
			...
			<input type="hidden" value ="<?php echo $id; ?>" name="id"> <!--remove the text input field and put type as hidden since its edit, the user will not need to input it again the input feild should be hidden -->
			...
			<div>
				...
				<div>
					<?php if (empty($published) && $published == 0): ?> <!-- to check if it was selected by the user when errors display -->
						<label>
